        ...
        <div class="card-header">Create product</div>
          <div class="card-body">
            ...
            <form method="POST" action="<?php echo e(route('product.save')); ?>">
              ...
              <input type="text" class="form-control mb-2" placeholder="Enter image url" name="image" value="<?php echo e(old('image')); ?>" />
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/juancamilosalazar/Desktop/si/Universidad/VII/Topicos Software/taller/resources/views/product/create.blade.php ENDPATH**/ ?>